...
cp              <- 3991.86795711963 # [m2 s-2 K-1] specific heat capacity of water 
                                    # 1) 3991.86795711963 for standard ocean reference salinity 
                                    #    35.16504 g kg-1 = 35 u_PS (standard ocean practical salinity) 
                                    #    and potential temperature θ = 25 °C from eq. 3.3.3 of 
...
if (runid == "demoid") {
    ...
    out_mode        <- "area" # what kind of netcdf output (see table below)
    sd_out                <- T
